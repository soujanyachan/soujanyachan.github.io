...
## Introduction [¶](https://golang.org/doc/effective_go#introduction)
...
### Examples [¶](https://golang.org/doc/effective_go#examples)
...
## Names [¶](https://golang.org/doc/effective_go#names)

Names are as important in Go as in any other language. They even have semantic effect: the visibility of a name outside a package is determined by whether its first character is upper case. It's therefore worth spending a little time talking about naming conventions in Go programs.

### Package names [¶](https://golang.org/doc/effective_go#package-names)
...
### Getters [¶](https://golang.org/doc/effective_go#Getters)
...
### Interface names [¶](https://golang.org/doc/effective_go#interface-names)
...
### MixedCaps [¶](https://golang.org/doc/effective_go#mixed-caps)

Finally, the convention in Go is to use `MixedCaps` or `mixedCaps` rather than underscores to write multiword names.

## Semicolons [¶](https://golang.org/doc/effective_go#semicolons)
...
## Control structures [¶](https://golang.org/doc/effective_go#control-structures)

The control structures of Go are related to those of C but differ in important ways. There is no `do` or `while` loop, only a slightly generalized `for`; `switch` is more flexible; `if` and `switch` accept an optional initialization statement like that of `for`; `break` and `continue` statements take an optional label to identify what to break or continue; and there are new control structures including a type switch and a multiway communications multiplexer, `select`. The syntax is also slightly different: there are no parentheses and the bodies must always be brace-delimited.

### If [¶](https://golang.org/doc/effective_go#if)
...
### Redeclaration and reassignment [¶](https://golang.org/doc/effective_go#redeclaration)
...
### For [¶](https://golang.org/doc/effective_go#for)
...
### Switch [¶](https://golang.org/doc/effective_go#switch)
...
### Type switch [¶](https://golang.org/doc/effective_go#type_switch)
...
## Functions [¶](https://golang.org/doc/effective_go#functions)

### Multiple return values [¶](https://golang.org/doc/effective_go#multiple-returns)
...
### Named result parameters [¶](https://golang.org/doc/effective_go#named-results)
...
## Data [¶](https://golang.org/doc/effective_go#data)
...
### Constructors and composite literals [¶](https://golang.org/doc/effective_go#composite_literals)
...
### Two-dimensional slices [¶](https://golang.org/doc/effective_go#two_dimensional_slices)
...
### Maps [¶](https://golang.org/doc/effective_go#maps)
...
To test for presence in the map without worrying about the actual value, you can use the [blank identifier](https://golang.org/doc/effective_go#blank) (`_`) in place of the usual variable for the value.
...
### Printing [¶](https://golang.org/doc/effective_go#printing)
...
### Append [¶](https://golang.org/doc/effective_go#append)
...
## Initialization [¶](https://golang.org/doc/effective_go#initialization)
...
### Interfaces [¶](https://golang.org/doc/effective_go#interfaces)
...
### Conversions [¶](https://golang.org/doc/effective_go#conversions)
...
### Interface conversions and type assertions [¶](https://golang.org/doc/effective_go#interface_conversions)
...
### Generality [¶](https://golang.org/doc/effective_go#generality)
...
### Interfaces and methods [¶](https://golang.org/doc/effective_go#interface_methods)
...
### The blank identifier in multiple assignment [¶](https://golang.org/doc/effective_go#blank_assign)
...
### Unused imports and variables [¶](https://golang.org/doc/effective_go#blank_unused)
...
### Import for side effect [¶](https://golang.org/doc/effective_go#blank_import)
...
### Interface checks [¶](https://golang.org/doc/effective_go#blank_implements)
...
## Concurrency [¶](https://golang.org/doc/effective_go#concurrency)

### Share by communicating [¶](https://golang.org/doc/effective_go#sharing)
...
### Channels of channels [¶](https://golang.org/doc/effective_go#chan_of_chan)
...
### Parallelization [¶](https://golang.org/doc/effective_go#parallel)
...
### A leaky buffer [¶](https://golang.org/doc/effective_go#leaky_buffer)
...
## Errors [¶](https://golang.org/doc/effective_go#errors)
...
### Panic [¶](https://golang.org/doc/effective_go#panic)
...
### Recover [¶](https://golang.org/doc/effective_go#recover)
...
## A web server [¶](https://golang.org/doc/effective_go#web_server)
